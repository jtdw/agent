...
def build_plan(project_root: Path, destination_root: Path) -> list[PlanItem]:
    ...
    movable = [
        ...
        ("artifacts", "Generated audit screenshots and validation reports outside the supported workspace model.", "Ignored/generated content."),
        (".superpowers", "Generated planning and brainstorming scratch state.", "Ignored/generated content."),
        ...
        ("ui_next/.playwright-cli", "Generated Playwright CLI snapshots.", "Not required by runtime."),
