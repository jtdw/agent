...
This project is indexed by GitNexus as **agent** (8193 symbols, 19160 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
