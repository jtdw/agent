...
from core.commercial.login_jobs import read_gscloud_login_job, request_gscloud_login_job_close, start_gscloud_login_process
...
class GSCloudAccountService:
    ...
    def complete_login(self, user_id: str, login_session_id: str) -> dict[str, Any]:
        ...
        if health.get("ok"):
            ...
            try:
                request_gscloud_login_job_close(self.commercial.workdir, login_session_id, reason="login_completed")
            except Exception:
                pass
            waiting_jobs = [
                job
