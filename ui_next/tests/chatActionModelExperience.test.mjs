...
assert.match(thesisWorkflowHookSource, /THESIS_WORKFLOW_PROMPT/, 'useChatThesisWorkflow should use the shared thesis workflow prompt');
assert.doesNotMatch(panelSource, /THESIS_WORKFLOW_PROMPT/, 'ChatPanel should not own thesis workflow prompt after hook extraction');
