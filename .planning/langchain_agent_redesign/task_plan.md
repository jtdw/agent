...
| Phase 58 CI runner/cache follow-up | planned | Consider lower-risk next accelerators such as Playwright browser caching or selective Linux runner migration for pure contract jobs. Keep Windows smoke until compatibility is proven. |
